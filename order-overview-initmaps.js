...
$("#edit_customer_btn").on("click", function () {
    $("#customer_modal_container").css("display", "flex");
    setTimeout(() => {
        $("#customer_modal_container").addClass("center-modal-container-active");
        $("#customer_center_modal").addClass("center-modal-active");
    }, 1);
});
